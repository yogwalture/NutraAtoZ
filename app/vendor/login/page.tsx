...
import { Loader2, AlertCircle, LogIn, UserPlus, CheckCircle2, Store } from "lucide-react";
    ...
    <div className="relative grid min-h-screen place-items-center overflow-hidden bg-gradient-to-br from-cream via-[hsl(28_100%_96%)] to-[hsl(340_65%_96%)] px-5">
      ...
      <div className="relative z-10 w-full max-w-sm animate-fade-up rounded-[2rem] border border-white/60 bg-white/80 p-8 shadow-float backdrop-blur-xl">
        <div className="flex flex-col items-center text-center">
          <img src="/nutraatoz-wordmark.png" alt="Nutraatoz" className="h-9 w-auto" />
          <h1 className="mt-4 flex items-center gap-2 font-serif text-2xl font-semibold text-ink">
          ...
          <p className="mt-1 text-xs text-mist">
            {mode === "signin"
              ...
              : "Create your vendor login to manage your store."}
          </p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            {mode === "signup" && (
              <p className="text-[11px] text-mist">
                Use the same email as your vendor application to link it
                automatically.
              </p>
            )}
          </div>
        ...
        <p className="mt-5 text-center text-xs text-mist">
          New to Nutraatoz?{" "}
          <a href="/vendor/onboarding" className="font-medium text-coral-600 hover:underline">
