            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-5">
              ...
              <div className="rounded-xl border border-border bg-secondary/40 p-3.5">
                ...
                <div className="mt-2 space-y-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="coa_status" className="text-xs text-muted-foreground">
                      CoA status
                    </Label>
                    <select
                      id="coa_status"
                      name="coa_status"
                      defaultValue={editing?.coa_status ?? ""}
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="lab_tested_url" className="text-xs text-muted-foreground">
                      CoA / lab report URL
                    </Label>
                    <Input
                      id="lab_tested_url"
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="coa_lab" className="text-xs text-muted-foreground">
                        Testing lab
                      </Label>
                      <Input
                        id="coa_lab"
                        name="coa_lab"
                        defaultValue={editing?.coa_lab ?? ""}
                        placeholder="Eurofins"
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label htmlFor="coa_batch" className="text-xs text-muted-foreground">
                        Batch no.
                      </Label>
                      <Input
                        id="coa_batch"
                        name="coa_batch"
                        defaultValue={editing?.coa_batch ?? ""}
                        placeholder="B-2409"
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label htmlFor="coa_date" className="text-xs text-muted-foreground">
                        Report date
                      </Label>
                      <Input
                        id="coa_date"
